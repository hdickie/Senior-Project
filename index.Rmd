...
varma.test <- vector.form.data[(end.train.data):nrow(vector.form.data),]
...
ylim.lb <- c(homepage.predictions$pred,lower.bounds) %>% min()
ylim.ub <- c(homepage.predictions$pred,upper.bounds) %>% max()
